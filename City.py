...
def maptest():
    ...
    if(surtilesInvalid==3):
        ...
        if(surtiles[newtile*10+2] != "00" and surtiles[newtile*10+2] !="0" and surtiles[newtile*10+2] !="99"):
            ...
            if(Map.MAP[surtiles[newtileX]][surtiles[newtileY]] == "1"): #if grass change to building
                Map.MAP[surtiles[newtileX]][surtiles[newtileY]] = str(10+random.randint(0,2))
                Map.GMAP[surtiles[newtileX]][surtiles[newtileY]] = "0"
            elif(Map.MAP[surtiles[newtileX]][surtiles[newtileY]] == "2" and isasurroundingtilex(surtiles[newtileX],surtiles[newtileY],"20")): #if road to be, change to road#
